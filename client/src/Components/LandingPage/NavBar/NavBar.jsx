...
import './Navbar.css'
import {Button, Col, Container, Nav, Navbar as BNavbar, NavDropdown, Row} from 'react-bootstrap';
            ...
            <Container>
                <Row>
                    <Col>
                        ...
                        <div className='logo'><Link to="/Flitrr">Flitrr</Link></div>
                        ...
                        <BNavbar.Toggle aria-controls="responsive-navbar-nav" style={{}}/>
                    </Col>
                </Row>
            </Container>
        </BNavbar>
